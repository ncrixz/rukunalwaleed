...
(function () {
  ...
  const I18N = {
    ar: {
      ...
      'hero.subtitle': 'مؤسسة ركن الوليد للتبريد والتكييف — مركز متخصص في إصلاح وصيانة المكيفات والثلاجات والمبردات. تعبئة فريون، فحص كهربائي، تنظيف عام، معايرة ثرموستات، وكشف تسريبات بأيدي فنيين خبراء وضمان على كل عمل.',
    ...
    en: {
      ...
      'hero.subtitle': 'Rukn Al Waleed is a specialized workshop for repairing and maintaining air conditioners, refrigerators, and coolers. Gas refilling, electrical check-up, general cleaning, thermostat calibration, and leak detection — performed by experienced technicians with a real warranty on every job.',
